<?php
require_once dirname( dirname( dirname( __FILE__ ) ) ) . '\classes\fileheaderreader.php';

class Dummy_FHR extends FileHeaderReader {
 ...
 */
class FileHeaderReaderTest extends \WP_UnitTestCase
{
	/**
