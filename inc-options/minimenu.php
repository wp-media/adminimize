		...
		<div class="inside">
			...
			<div style="padding:.3em 1em;">
				...
				<?php if ( _mw_adminimize_is_active_on_multisite() ) { ?>
					<p><?php esc_attr_e(
							'You have activated the Plugin for your Multisite Network. Your settings works now for each site in the network. You set the settings for network, but set it on one site of the network, there you will have all active menu items and plugins by default. Does it look clearer for you? If you update the settings then write the plugin new settings in dependence of the blog where you put, save the settings.',
							'adminimize'
						); ?></p>
				<?php } ?>
			</div>
