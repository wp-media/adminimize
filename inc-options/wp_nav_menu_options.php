...
?>
		<div id="poststuff" class="ui-sortable meta-box-sortables">
			<div class="postbox">
				...
				<h3 class="hndle" id="nav_menu_options"><?php _e('WP Nav Menu options', 'adminimize' ); ?></h3>
				<div class="inside">
					<br class="clear" />
					...
					<table summary="config_nav_menu" class="widefat">
						...
						<?php
							...
							$nav_menu_options_names = array(
								__('Help', 'adminimize'),
								__('Screen Options'),
								__('Theme Locations', 'adminimize'),
								__('Custom Links', 'adminimize'),
								'#(' . __('Add menu', 'adminimize') . ')'
							);
					...
					<table summary="config_edit_post" class="widefat">
						<thead>
							<tr>
								<th><?php _e('Your own Nav Menu options', 'adminimize' ); echo '<br />'; _e('ID or class', 'adminimize' ); ?></th>
