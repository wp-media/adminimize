					...
					<tr valign="top">
						...
						<td>
							...
							<select name="_mw_adminimize_exclude_super_admin">
								...
								<option value="1"
								<?php
								if ( $_mw_adminimize_exclude_super_admin === 1 ) {
									echo ' selected="selected"';
								}
								?>
				...
				if ( '' !== $disabled_menu_all ) {
					...
					<tr valign="top">
						...
						<td>
							...
							<br>
							<textarea style="width: 85%;" class="code" rows="1" cols="60" name="_mw_adminimize_db_redirect_txt" id="_mw_adminimize_db_redirect_txt">
							<?php
